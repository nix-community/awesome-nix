...
* [kanidm module](https://github.com/oddlama/nix-config/blob/main/modules/kanidm.nix) - Provisioning of users, groups and oauth2 resources in SSO [kanidm](https://github.com/kanidm/kanidm/).
