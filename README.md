...
* [Nix Config for macOS + NixOS](https://github.com/dustinlyons/nixos-config) - Well documented flake configuration with step-by-step guides and starter templates
